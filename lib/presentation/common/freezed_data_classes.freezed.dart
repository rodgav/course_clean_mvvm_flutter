...
class _$RegisterObjectTearOff {
  ...
  _RegisterObject call(String countryMobile, String name, String email,
...
mixin _$RegisterObject {
  String get countryMobile => throw _privateConstructorUsedError;
...
class _$RegisterObjectCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      countryMobile: countryMobile == freezed
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.countryMobile, this.name, this.email, this.password,
      this.mobileNumber, this.profilePicture);

  @override
  final String countryMobile;
  @override
  final String name;
  @override
  final String email;
  ...
  @override
  String toString() {
    return 'RegisterObject(countryMobile: $countryMobile, name: $name, email: $email, password: $password, mobileNumber: $mobileNumber, profilePicture: $profilePicture)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.countryMobile, countryMobile) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(countryMobile),
